...
class RedSocial(models.Model):
    ...
    url = models.URLField(
        _(u"URL"), max_length=200)
    icono_svg = models.FileField(
        _('Ícono SVG'), upload_to='uploads/farsali/red_social/',
...
class GaleriaGeneric(models.Model):
    ...
    imagen = models.ImageField(
        _(u'Imagen'), upload_to='uploads/cms_apps/imagenes/', max_length=200)
    orden = models.PositiveIntegerField(
        _(u'Orden'), default=0)
    activo = models.BooleanField(
        _(u'Activo'), default=True)
...
class Constante(models.Model):
    ...
    tipo = models.CharField(_(u'Tipo'), max_length=10, choices=TIPOS,
                            default='str')
    valor = models.TextField(_(u'Valor'))
    icono_svg = models.FileField(
        _('Ícono SVG'), upload_to='uploads/farsali/constantes/',
        blank=True, null=True)
    icono = models.ImageField(
        u'Ícono',
