...
class Marca(models.Model):
    ...
    tipo_marca = models.SmallIntegerField(
        _(u'Tipo de Marca'),
        choices=TIPOS_MARCAS,
        default=0
    )
...
class ImagenBase(models.Model):
    nombre = models.CharField(_(u"Nombre"), max_length=100, blank=True,
                              null=False, default='')
    imagen = models.ImageField(
        _(u'Imagen'),
        upload_to='uploads/inventario/imagenes/',
...
class Producto(models.Model):
    ...
    costo_farsali = models.FloatField(
        _(u"Costo Farsali"),
        default=0.0
    )
    activo = models.BooleanField(
    ...
    calificacion = models.IntegerField(
        _(u'Calificacion'),
        choices=STAR_QUALITY,
        blank=True,
        null=True
    )
    cantidad_cajas = models.PositiveIntegerField(
        _(u'Cantidad x Cajas'),
        default=0)
    cantidad_cajas_prefer = models.PositiveIntegerField(
        _(u'Cantidad x Cajas Farsali'),
        default=0)
    cantidad = models.PositiveIntegerField(
        _(u'Cantidad en almacén'))
    orden = models.PositiveIntegerField(
        _(u'Orden'),
        default=0
    )
...
class Comentario(models.Model):
    ...
    estado = models.IntegerField(
        _(u'Estado'), choices=ESTADOS, default=0)
    comentario = models.TextField(
        _(u'Comentario'), max_length=1000, default='')
    titulo = models.CharField(
        _(u'Título'), max_length=150, default='', null=True, blank=True)
    nombre = models.CharField(
        _(u'Nombre'), max_length=150, default='', null=True, blank=True)
    email = models.EmailField(
        _(u'Email'), max_length=150, null=True, blank=True)
